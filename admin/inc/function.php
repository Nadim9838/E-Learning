...
function view_lang(){
    ...
    while($row=$get_lang->fetch()):
        ...
        <td>".$i++."</td>
        <td>".$row['lang_name']."</td>
        <td><a href='index.php?lang&edit_lang=".$row['lang_id']."'>Edit</a></td>
        <td><a href='index.php?lang&del_lang=".$row['lang_id']."'>Delete</a></td>
        <tr>";
    endwhile;
...
function view_cat(){
    ...
    while($row=$get_cat->fetch()):
        ...
        <td><a href='index.php?cat&del_cat=".$row['cat_id']."'>Delete</a></td>
        <tr>";
    endwhile;
...
function view_sub_cat(){
    ...
    while($row=$get_cat->fetch()):
        ...
        <td><a href='index.php?sub_cat&del_sub_cat=".$row['sub_cat_id']."'>Delete</a></td>
        <tr>";
    endwhile;
...
function add_faqs() {
    ...
    if(isset($_POST['add_faqs'])) {
        ...
        $check=$con->prepare("select * from faqs where qFAQs'");
        $check->setFetchMode(PDO:: FETCH_ASSOC);
        $check->execute();
        $count=$check->rowCount();
